...
# UPDATED = 2026-06-05
LITERT_REF = "b77c5c36c5c9c765ac2710eae5d1f115c9a8870a"

LITERT_SHA256 = ""

TENSORFLOW_REF = "97f383ddc524f5cb60c8387ec55e81402dbfcb3f"

TENSORFLOW_SHA256 = "c29ef319c524eee22d2ee177d7e17087f1c66e46e021a237a7031c288198a128"
...
http_archive(
    name = "litert_lm",
    strip_prefix = "LiteRT-LM-af0f0c9d9fb120f765d0163b9ae1fae8cf149527",
    url = "https://github.com/google-ai-edge/LiteRT-LM/archive/af0f0c9d9fb120f765d0163b9ae1fae8cf149527.tar.gz",
)
...
http_archive(
    name = "org_tensorflow",
    patches = ["@//bazel:PATCH.tensorflow"],
...
http_archive(
    name = "rules_rust",
    patches = ["@//bazel:PATCH.rules_rust"],
...
crates_repository(
    ...
    annotations = {
        "llguidance": [
            crate.annotation(
                additive_build_file = "@//bazel:BUILD.llguidance",
                gen_build_script = False,
                patches = [
                    "@//bazel:PATCH.llguidance_regexvec",
                    "@//bazel:PATCH.llguidance_numeric",
                    "@//bazel:PATCH.llguidance_grammar",
                    "@//bazel:PATCH.llguidance_parser",
                    "@//bazel:PATCH.llguidance_perf",
                ],
            ),
        ],
        "toktrie": [
            crate.annotation(
                patches = ["@//bazel:PATCH.toktrie"],
            ),
        ],
    },
...
http_archive(
    name = "minizip",
    add_prefix = "minizip",
    build_file = "@//bazel:BUILD.minizip",
...
http_archive(
    name = "sentencepiece",
    build_file = "@//bazel:BUILD.sentencepiece",
    patch_cmds = [
    ...
    patches = ["@//bazel:PATCH.sentencepiece"],
...
http_archive(
    name = "tokenizers_cpp",
    build_file = "@//bazel:BUILD.tokenizers_cpp",
...
http_archive(
    name = "minja",
    build_file = "@//bazel:BUILD.minja",
    patches = ["@//bazel:PATCH.minja"],
...
http_archive(
    name = "miniaudio",
    build_file = "@//bazel:BUILD.miniaudio",
...
load("@//bazel:android_ndk_env.bzl", "check_android_ndk_env")
...
http_archive(
    name = "nanobind_json",
    build_file = "@//bazel:BUILD.nanobind_json",
    patches = ["@//bazel:PATCH.nanobind_json"],
